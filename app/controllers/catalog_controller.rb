...
#    config.add_facet_field solr_name('member_of_collections', :symbol), label: "Collection Member", limit: 5, label: 'Collections'
    ...
    config.add_index_field solr_name("based_near", :stored_searchable), label: "Geographic Location", itemprop: 'location'
...
#    config.add_index_field solr_name("depositor"), label: "Owner", helper_method: :link_to_profile
    config.add_index_field solr_name("publisher", :stored_searchable), label: "Publishe", itemprop: 'publisher', link_to_search: solr_name("publisher", :facetable)
...
#    config.add_index_field solr_name("date_modified", :stored_sortable, type: :date), label: "Date Modified", itemprop: 'dateModified', helper_method: :human_readable_date
    config.add_index_field solr_name("date_created", :stored_searchable), label: "Publication Date", itemprop: 'dateCreated'
...
#    config.add_index_field solr_name("lease_expiration_date", :stored_sortable, type: :date), label: "Lease expiration date", helper_method: :human_readable_date
    ...
    config.add_show_field solr_name("keyword", :stored_searchable), label: "Keywords"
    config.add_show_field solr_name("commodities", :stored_searchable), label: "Commodity", itemprop: 'commodities'
    config.add_show_field solr_name("value_chain", :stored_searchable), label: "Value Chain", itemprop: 'value chain'
    config.add_show_field solr_name("based_near", :stored_searchable), label: "Geographic Location", itemprop: 'location'
...
#    config.add_show_field solr_name("based_near_label", :stored_searchable)
    ...
    config.add_show_field solr_name("date_created", :stored_searchable), label: "Publication Date"
